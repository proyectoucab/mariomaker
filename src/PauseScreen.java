...
/*
 * Representa la pantalla que aparece cuando hay un juego en curso y está pausado.
 */
public class PauseScreen extends Pantalla {
	...
	public PauseScreen(boolean puedeGuardar){ //Constructor
		this.puedeGuardar = puedeGuardar;
		menuPrincipalSeleccionado = false;
		//Pantalla de menu inicial y de niveles
	...
	public void draw(Graphics g) {   //Dibujar por pantalla
